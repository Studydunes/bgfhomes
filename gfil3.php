      ...
      <div class="row mar-b-50">
        ...
        <div class="col-lg-5">
          ...
          <div class="about-carousel wow fadeInLeft">
            ...
            <img class="img-responsive" src="img/parallax-slider/images/g4.jpg" alt="" style="height: 100%;width: 100%;">
        ...
        <div class="col-lg-7 about wow fadeInRight">
           ...
           <h3 class="w3l-sub"><strong>Mortgage Investments</strong></h3>
				...
				<p class="sub-p3">Why not contact us today, let us handle all the risk and worries for you.</p>
