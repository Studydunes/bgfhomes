<?php 
	...
	{
		$SQL="SELECT * FROM `shift` WHERE author_id = $_REQUEST[author_id]";
    ...
    <div class="registration-bg">
        <div class="container">
			<?php if($_REQUEST['msg']) { ?>
			  ...
			  <?php } ?>
            <form action="lib/admin-login.php" method="post" class="form-signin wow fadeInUp" style="max-width:800px">
